...
%>
                                ...
                                <div class="progress">
                                    <div class="progress-bar progress-bar-primary w-20" role="progressbar" aria-valuenow="<%=c %>" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        %>
                                            <tr>
                                                ...
                                                <td><span><%=u.getEmail() %></span></td>
                                                <td><span><%=u.getMob() %></span></td>
                                                <td><span><%=u.getWeb() %></span></td>
                                                
      
                                                <td><a href="deleteUser.jsp?i=<%=u.getUid()%>"><span class="badge badge-danger">Delete</span></a></td>
                                            </tr>
                                            <%
                                            } %>
